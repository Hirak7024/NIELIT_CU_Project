...
export default function CreateBlog({ placeholder }) {
    ...
    return (
        <div className='ml-[20rem] w-[100vw] h-[100vh] bg-blue-50'>
            <h1 className='text-[24px] font-[700] mb-[15px] ml-[2rem] mt-[1.5rem]'>Create a Blog</h1>
            <form
                className='w-[75vw] bg-white flex flex-col gap-[5px] items-center px-[2rem] ml-[1.5rem] mt-[1rem] pt-[15px] pb-[15px] rounded-[10px]'
