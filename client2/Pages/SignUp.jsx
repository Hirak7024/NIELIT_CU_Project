        ...
        <div className='w-screen h-screen flex items-center justify-center bg-[#F7F9FF]'>
            <div className='w-[468px] shadow-md'>
                ...
                <form onSubmit={handleSubmit} className='bg-white p-[24px] flex flex-col'>
                    <h1 className='text-[24px] mb-[1rem] font-[900]'>Sign Up</h1>
                    <h3 className='text-[16px] mb-[5px]'>Name</h3>
                    ...
                    <p className='text-[16px] flex gap-[10px] self-center'>Already have an account ? <u onClick={() => navigate("/login")} className='font-[700] text-[#2B59E3] cursor-pointer'>Sign In</u></p>
                </form>
            </div>
        </div>
    )
